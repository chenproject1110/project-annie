    ...
    <main className="min-h-screen bg-bg">
      <div className="mx-auto max-w-7xl px-8 py-6 sm:py-10">
        ...
        <div className="flex items-center gap-4">
          <div className="h-16 w-16 shrink-0 rounded-2xl bg-line/10 animate-pulse" />
          <div className="space-y-2">
            <div className="h-4 w-16 rounded bg-line/5 animate-pulse" />
            <div className="h-9 w-56 max-w-full rounded-lg bg-line/10 animate-pulse" />
          </div>
        </div>
